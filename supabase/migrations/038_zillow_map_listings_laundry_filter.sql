-- Add optional laundry filter to get_zillow_map_listings (Zillow rent map).
-- p_laundry: text[] of 'in_unit' | 'shared' | 'none'; NULL or empty = no filter.
-- Mid-market: match listing laundry. REIT: include if any unit in the building in base_pre matches.
