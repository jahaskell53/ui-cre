-- The UI treats missing `beds` as 0 (studio). Keep RPC results consistent.
-- Used by /analytics/comps via supabase.rpc('get_comps', ...).
...
GRANT EXECUTE ON FUNCTION public.get_comps(double precision, double precision, double precision, integer, integer, numeric, integer, integer, numeric, boolean, integer, text, boolean, integer[]) TO anon, authenticated;
