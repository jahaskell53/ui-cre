...
from zillow_pipeline.assets import cleaned_listings, zip_codes, zillow_scrape, zillow_building_scrape, cleaned_building_units, refresh_unit_breakdown_views, loopnet_search_scrape, loopnet_detail_scrape, cleaned_loopnet_listings, download_om_pdfs, extract_om_metrics
...
from zillow_pipeline.schedules import weekly_scrape_schedule, weekly_loopnet_scrape_schedule, zillow_cleaning_job, zillow_scrape_job, zillow_building_job, loopnet_scrape_job, loopnet_cleaning_job, loopnet_om_job, loopnet_om_metrics_job, trigger_cleaning_job_after_scrape, trigger_building_job_after_cleaning, trigger_loopnet_cleaning_after_scrape, trigger_om_download_after_cleaning, trigger_om_metrics_after_om_download, alert_on_pipeline_failure, alert_on_pipeline_success

all_assets = load_assets_from_modules([zip_codes, zillow_scrape, cleaned_listings, zillow_building_scrape, cleaned_building_units, refresh_unit_breakdown_views, loopnet_search_scrape, loopnet_detail_scrape, cleaned_loopnet_listings, download_om_pdfs, extract_om_metrics])
...
defs = Definitions(
    ...
    sensors=[
        ...
        trigger_om_metrics_after_om_download,
