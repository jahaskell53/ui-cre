...
from zillow_pipeline.schedules import weekly_scrape_schedule, zillow_cleaning_job, zillow_scrape_job, zillow_building_job, trigger_cleaning_job_after_scrape, trigger_building_job_after_cleaning, alert_on_pipeline_failure
...
defs = Definitions(
    ...
    sensors=[trigger_cleaning_job_after_scrape, trigger_building_job_after_cleaning, alert_on_pipeline_failure],
    resources={
