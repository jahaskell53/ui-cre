...
export function getProviderScopes(provider: Provider): string[] {
    switch (provider) {
        ...
        case "outlook":
            return ["https://graph.microsoft.com/Mail.Read", "https://graph.microsoft.com/Calendars.Read", "https://graph.microsoft.com/Contacts.Read"];
        case "yahoo":
        case "icloud":
            ...
            return ["email.read_only", "calendar.read_only", "contacts.read_only"];
        default:
            return ["email.read_only", "calendar.read_only", "contacts.read_only"];
    }
}
