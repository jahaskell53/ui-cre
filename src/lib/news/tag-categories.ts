...
export const TAG_CATEGORIES = {
    ...
    "multi-family":
        "Multi-family residential properties (3+ unit apartments, condos, larger buildings) for investment or development but NOT about individual family purchases/homes",
    ...
    national:
        "National-level real estate trends and policies that apply broadly across the entire United States. Do NOT use for articles about specific cities, counties, or regions",
