            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-50">
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>We're syncing your emails and calendar events. This may take a minute.</CardDescription>
                    </CardHeader>
                </Card>
            </div>
        );
            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-50">
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>Your contacts have been imported successfully. Redirecting...</CardDescription>
                    </CardHeader>
                </Card>
            </div>
        );
        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
            <Card className="w-full max-w-2xl">
                <CardHeader className="text-center">
                    ...
                    <CardDescription className="text-base">Import contacts from your email and calendar to build your network automatically</CardDescription>
                </CardHeader>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                        {providers.map((provider) => (
                            ...
                            >
                                ...
                                {connecting === provider.id && <Loader2 className="h-5 w-5 animate-spin text-gray-600" />}
                            </button>
                        ))}
                    </div>

                    <div className="border-t pt-6">
                        <Button variant="ghost" onClick={handleSkip} disabled={connecting !== null} className="w-full">
                            Skip for now
                        </Button>
                        <p className="mt-2 text-center text-sm text-gray-500">You can connect your email later in settings</p>
                    </div>
                </CardContent>
            </Card>
        </div>
