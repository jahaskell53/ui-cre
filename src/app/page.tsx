...
import { Heart, MessageCircle01, Share01, Bookmark, MessageChatSquare, BarChartSquare01, Send01 } from "@untitledui/icons";
                ...
                <div className="border-t border-secondary bg-secondary/20 p-6 animate-in slide-in-from-top-2 duration-200">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-4">
                            {[
                                { name: "David Miller", text: "Great insights on the secondary markets. We're seeing similar trends in the Southwest.", time: "2h ago", initials: "DM" },
                                { name: "Sarah Chen", text: "How do you think the new Florida caps will affect refinancing timelines?", time: "45m ago", initials: "SC" }
                            ].map((comment, i) => (
                                <div key={i} className="flex gap-3">
                                    <Avatar size="xs" initials={comment.initials} />
                                    <div className="flex-1 bg-primary p-3 rounded-xl border border-secondary shadow-xs">
                                        <div className="flex justify-between items-center mb-1">
                                            <span className="text-xs font-bold text-primary">{comment.name}</span>
                                            <span className="text-[10px] text-tertiary uppercase">{comment.time}</span>
                                        </div>
                        ...
                        <div className="flex gap-3 items-start mt-2">
                            ...
                            <div className="flex-1 flex gap-2">
                                <Input
                                    ...
                                    size="sm"
                                />
                                <Button color="primary" size="sm" iconLeading={Send01} className="shrink-0" />
                            </div>
                        </div>
                    </div>
                </div>
