...
export async function GET(request: NextRequest) {
    try {
        ...
        console.error("Error in GET /api/news/prepare-newsletters:", error);
...
function shouldPrepareNewsletterForSubscriber(subscriber: { preferredSendTimes?: PreferredSendTime[]; timezone?: string }, targetTime: Date): boolean {
