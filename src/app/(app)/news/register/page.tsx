...
type RegistrationStep = "initial-interests" | "questions" | "review" | "complete" | "confirmation";
...
export default function RegisterPage() {
    ...
    useEffect(() => {
        ...
        if (saved) {
            ...
            if (saved.preferences && saved.preferences.length > 0) {
                ...
                const firstUnanswered = saved.clarifyingQuestions.findIndex((_, idx) => !saved.conversation || !saved.conversation[idx]);
    ...
    const handleCompleteSubmit = async () => {
        ...
        const finalInterests = preferences.length > 0 ? JSON.stringify(preferences) : interests.filter((i) => i.trim() !== "").join(", ");
    ...
    return (
        <div className="flex h-full w-full flex-col overflow-hidden bg-white dark:bg-gray-900">
            ...
            <div className="flex-1 overflow-y-auto bg-white dark:bg-gray-900">
                <div className="mx-auto w-full max-w-4xl px-2 py-8 sm:px-4">
                    ...
                    {currentStep === "confirmation" && user?.email && <ConfirmationStep userEmail={user.email} onBackToNews={handleBackToNews} />}
