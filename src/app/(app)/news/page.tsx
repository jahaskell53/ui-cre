          ...
          <div className="relative flex">
            ...
            <div className="relative">
              <select
                ...
                className="absolute inset-y-0 right-0 w-32 px-3 py-2 border border-gray-200 dark:border-gray-800 border-l-0 rounded-r-lg bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer"
              >
