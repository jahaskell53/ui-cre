...
import { AreaSelection, SalesTrendRow, buildMultiAreaSalesData, formatMillions, pctChange } from "./trends-utils";
...
export function SalesTrendsSection({ areas, areaResults, salesSource = "loopnet" }: Props) {
    ...
    const absData = useMemo(() => buildMultiAreaSalesData(areaResults, areas, metric), [areaResults, areas, metric]);
