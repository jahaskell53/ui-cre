...
export default function PeopleLayout({ children }: { children: React.ReactNode }) {
    ...
    const isDetailPage =
        pathname?.match(/^\/network\/[^/]+(\/.*)?$/) && pathname !== "/network/create" && pathname !== "/network/board" && pathname !== "/network/map";

    const shouldHideDetailPanel = pathname === "/network/create" || isDetailPage;
    ...
    return (
        ...
        >
            <div className="flex h-full w-full">
                {/* Main Content */}
                <div className="flex min-w-0 flex-1 flex-col overflow-hidden bg-white dark:bg-gray-900">
                ...
                {!shouldHideDetailPanel && (
                    <div
                        ...
                        className="group hidden w-1 flex-shrink-0 cursor-col-resize items-center justify-center lg:flex"
                    >
