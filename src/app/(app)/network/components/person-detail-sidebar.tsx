...
import { CellularIcon, LocationIcon, MailIcon } from "../icons";
...
export function PersonDetailSidebar({ person, onToggleStar, firstName, panelWidth }: PersonDetailSidebarProps) {
    ...
    return (
        <div className="flex-shrink-0 border-l border-gray-200 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-800/50" style={{ width: `${panelWidth}px` }}>
            <ScrollArea className="h-full">
                <div className="p-4">
                    {/* Clock icon top right */}
                    <div className="mb-4 flex justify-end">
                        <button className="rounded-md p-1.5 text-gray-400 hover:bg-gray-100 dark:text-gray-500 dark:hover:bg-gray-700">
                    ...
                    <div className="mb-6">
                        ...
                        {stats.hasInteractions && <p className="mb-3 text-xs leading-relaxed text-gray-600 dark:text-gray-400">{formatSourcesText()}</p>}
                    ...
                    {(person.email || person.phone) && (
                        <>
                            <div className="mb-6">
                                <h3 className="mb-3 text-xs font-medium tracking-wide text-gray-500 uppercase dark:text-gray-400">Contact Information</h3>
                                {person.email && (
                                ...
                                {person.phone && (
                                    <div className="flex items-center gap-2">
                                        ...
                                        <a href={`tel:${person.phone}`} className="text-xs text-blue-600 hover:underline dark:text-blue-400">
                                            {person.phone}
                                        </a>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Owned Addresses */}
                            {person.owned_addresses && person.owned_addresses.length > 0 && (
                                <div>
                    ...
                    {/* Groups */}
                    <div className="mb-6">
                        <h3 className="mb-3 text-xs font-medium tracking-wide text-gray-500 uppercase dark:text-gray-400">Groups</h3>
                        <Badge
                            variant="secondary"
                            className={cn(
                        ...
                        >
                            <StarIcon className={cn("mr-1 h-3 w-3", person.starred ? "text-amber-400" : "text-gray-400")} filled={person.starred} />
                            STARRED
                        </Badge>
                    </div>
                    ...
                    {(person.address || (person.owned_addresses && person.owned_addresses.length > 0)) && (
                        <>
                            ...
                            <div className="mb-6">
                                ...
                                <PersonPropertyMap
                                    addresses={[...(person.address ? [person.address] : []), ...(person.owned_addresses || [])]}
