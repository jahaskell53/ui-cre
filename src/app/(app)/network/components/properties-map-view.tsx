...
export function PropertiesMapView({ people, searchQuery, showStarredOnly, onSelectPerson }: PropertiesMapViewProps) {
    ...
    useEffect(() => {
        ...
        propertyLocations.forEach((location) => {
            ...
            root.render(
                <MapPopupContent personName={location.person.name} category={location.person.category} label={location.label} address={location.address} />,
            );
    ...
    return (
        <div className="relative flex min-w-0 flex-1 flex-col">
            {/* Map */}
            <div ref={mapContainer} className="w-full flex-1" style={{ minHeight: "400px" }} />
        </div>
    );
}
