...
export function HomeIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M6 13.5H12M8.18 1.764L2.43 6.204C2.01 6.522 1.8 6.681 1.647 6.878C1.51 7.053 1.408 7.252 1.347 7.464C1.278 7.703 1.278 7.961 1.278 8.478V13.02C1.278 13.948 1.278 14.412 1.459 14.77C1.618 15.084 1.872 15.338 2.186 15.497C2.544 15.678 3.008 15.678 3.936 15.678H14.064C14.992 15.678 15.456 15.678 15.814 15.497C16.128 15.338 16.382 15.084 16.541 14.77C16.722 14.412 16.722 13.948 16.722 13.02V8.478C16.722 7.961 16.722 7.703 16.653 7.464C16.592 7.252 16.49 7.053 16.353 6.878C16.2 6.681 15.99 6.522 15.57 6.204L9.82 1.764C9.496 1.52 9.334 1.398 9.156 1.352C8.999 1.312 8.834 1.312 8.677 1.352C8.499 1.398 8.337 1.52 8.013 1.764L8.18 1.764Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
...
export function PeopleIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M15 15.75C15 14.5074 15 13.8861 14.8463 13.3836C14.4921 12.2271 13.5229 11.3079 12.3036 10.9687C11.7748 10.8225 11.1178 10.8225 9.80385 10.8225H8.19615C6.88225 10.8225 6.2253 10.8225 5.6964 10.9687C4.4771 11.3079 3.5079 12.2271 3.1537 13.3836C3 13.8861 3 14.5074 3 15.75M12.375 5.625C12.375 7.48896 10.864 9 9 9C7.13604 9 5.625 7.48896 5.625 5.625C5.625 3.76104 7.13604 2.25 9 2.25C10.864 2.25 12.375 3.76104 12.375 5.625Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
...
export function MailIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M1 3.5L5.2 6.3C5.68 6.62 6.32 6.62 6.8 6.3L11 3.5M2.2 10H9.8C10.46 10 11 9.46 11 8.8V3.2C11 2.54 10.46 2 9.8 2H2.2C1.54 2 1 2.54 1 3.2V8.8C1 9.46 1.54 10 2.2 10Z"
                stroke="currentColor"
                strokeWidth="1"
                strokeLinecap="round"
                strokeLinejoin="round"
