...
export default function PeoplePage() {
    const { people, setPeople, selectedPerson, setSelectedPerson, loading, showStarredOnly, setShowStarredOnly, searchQuery, sortBy, reverse } = usePeople();
    ...
    const filteredPeople = sortedPeople.filter((person) => {
        ...
        if (searchQuery.trim()) {
            ...
            const searchableFields = [person.name, person.email, person.phone, person.category, person.address, ...(person.owned_addresses || [])]
                .filter(Boolean)
