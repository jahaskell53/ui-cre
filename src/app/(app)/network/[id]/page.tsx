...
function MessageIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M6.5 8.5H6.51M10 8.5H10.01M13.5 8.5H13.51M6 13.5L3.5 16V5.5C3.5 4.4 4.4 3.5 5.5 3.5H14.5C15.6 3.5 16.5 4.4 16.5 5.5V11.5C16.5 12.6 15.6 13.5 14.5 13.5H6Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
...
function CopyIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                d="M13.5 6.5V5C13.5 4.17 12.83 3.5 12 3.5H5C4.17 3.5 3.5 4.17 3.5 5V12C3.5 12.83 4.17 13.5 5 13.5H6.5"
                stroke="currentColor"
                strokeWidth="1.5"
            />
        </svg>
...
function LabelIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M2 4.5C2 3.4 2.9 2.5 4 2.5H7.59C8.12 2.5 8.63 2.71 9 3.09L13.41 7.5C14.2 8.29 14.2 9.54 13.41 10.33L10.33 13.41C9.54 14.2 8.29 14.2 7.5 13.41L3.09 9C2.71 8.63 2.5 8.12 2.5 7.59V4.5H2Z"
                stroke="currentColor"
                strokeWidth="1.5"
            />
...
function CalendarIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M10.5 1.5V4M5.5 1.5V4M2 6.5H14M3 3H13C13.5523 3 14 3.44772 14 4V13C14 13.5523 13.5523 14 13 14H3C2.44772 14 2 13.5523 2 13V4C2 3.44772 2.44772 3 3 3Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
...
function MailIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M2 4.5L7.2 8.3C7.68 8.62 8.32 8.62 8.8 8.3L14 4.5M3.2 13H12.8C13.46 13 14 12.46 14 11.8V4.2C14 3.54 13.46 3 12.8 3H3.2C2.54 3 2 3.54 2 4.2V11.8C2 12.46 2.54 13 3.2 13Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
...
function StarIcon({ className, filled }: { className?: string; filled?: boolean }) {
    return (
        <svg className={className} width="14" height="14" viewBox="0 0 14 14" fill={filled ? "currentColor" : "none"} xmlns="http://www.w3.org/2000/svg">
            <path
                d="M7 1L8.545 4.76L12.5 5.27L9.75 7.94L10.455 11.87L7 10.03L3.545 11.87L4.25 7.94L1.5 5.27L5.455 4.76L7 1Z"
                stroke="currentColor"
                strokeWidth="1"
                strokeLinecap="round"
                strokeLinejoin="round"
...
function TrashIcon({ className }: { className?: string }) {
    return (
        <svg className={className} width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M3 5H17M8 5V3.5C8 2.67 8.67 2 9.5 2H10.5C11.33 2 12 2.67 12 3.5V5M15.5 5V15.5C15.5 16.33 14.83 17 14 17H6C5.17 17 4.5 16.33 4.5 15.5V5H15.5ZM8.5 8.5V13.5M11.5 8.5V13.5"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
...
export default function PersonDetailPage() {
        ...
        return (
            <div className="flex h-screen items-center justify-center bg-white dark:bg-gray-900">
                <div className="text-center">
                    <div className="mb-4 text-sm text-gray-500 dark:text-gray-400">{error || "Person not found"}</div>
                    <button onClick={handleBack} className="text-sm text-blue-600 hover:underline dark:text-blue-400">
                        Back to People
                    </button>
                </div>
            </div>
    ...
    const displayTimeline = timelineFilter === "all" ? allTimeline : allTimeline.filter((item) => item.type === timelineFilter);
    ...
    return (
        <div className="flex h-screen bg-white dark:bg-gray-900">
            ...
            <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-800">
                    ...
                    <div className="flex items-center gap-2">
                        <Button onClick={() => setIsTourOpen(true)} variant="outline" size="sm" className="bg-white shadow-sm dark:bg-gray-900">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button
                                    ...
                                    className="rounded-md p-1.5 text-gray-400 hover:bg-gray-100 dark:text-gray-500 dark:hover:bg-gray-800"
                                >
                            ...
                            <DropdownMenuContent align="end" className="w-64">
                                <div className="px-2 py-1.5">
                                    <div className="mb-2 text-xs font-medium tracking-wide text-gray-500 uppercase dark:text-gray-400">Contact Information</div>
                                </div>
                                {person.email && (
                                    <DropdownMenuItem
                                ...
                                {person.phone && (
                                    ...
                                    >
                                        ...
                                        <span className="truncate text-sm">{person.phone}</span>
                                    </DropdownMenuItem>
                                )}
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="rounded-md p-1.5 text-gray-400 hover:bg-gray-100 dark:text-gray-500 dark:hover:bg-gray-800">
                                    <CopyIcon className="h-5 w-5" />
                                </button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-48">
                                {person.email && (
                                    <DropdownMenuItem onClick={() => handleCopy(person.email!, "email")} className="flex cursor-pointer items-center gap-2">
                                        <MailIcon className="h-4 w-4" />
                                        <span>Copy Email</span>
                                    </DropdownMenuItem>
                                )}
                                {person.phone && (
                                    <DropdownMenuItem onClick={() => handleCopy(person.phone!, "phone")} className="flex cursor-pointer items-center gap-2">
                                ...
                                {person.address && (
                                    <DropdownMenuItem onClick={() => handleCopy(person.address!, "address")} className="flex cursor-pointer items-center gap-2">
                ...
                <div className="px-4 py-6 md:px-6">
                    <div className="flex items-center gap-4">
                        <Avatar className="h-16 w-16 md:h-20 md:w-20">
                            <AvatarFallback className="text-2xl font-medium text-white" style={{ background: generateAuroraGradient(person.name) }}>
                        ...
                        <div>
                            ...
                            <div className="mt-1 flex items-center gap-2">
                                {person.timeline && person.timeline.some((item) => item.type === "email") && (
                                    <Badge
                                        variant="secondary"
                                        className="bg-orange-100 px-2 py-0.5 text-xs font-medium text-orange-600 dark:bg-orange-900/30 dark:text-orange-400"
                                    >
                                        AUTO
                                    </Badge>
                                )}
                                ...
                                {person.birthday &&
                                    (() => {
                                        ...
                                        return (
                                            <Badge
                                                variant="secondary"
                                                className="group flex cursor-default items-center gap-1 bg-purple-100 px-2 py-0.5 text-xs font-medium text-purple-700 dark:bg-purple-900/30 dark:text-purple-400"
                                                title={`${dateStr} - ${actualAge} years old`}
                                            >
                                                <Cake className="h-3 w-3 group-hover:hidden" />
                ...
                {/* Tabs */}
                <Tabs value={selectedTab} onValueChange={setSelectedTab} className="flex flex-1 flex-col overflow-hidden">
                    <div className="border-b border-gray-200 px-4 md:px-6 dark:border-gray-800">
                        <div className="flex items-center justify-between">
                            <TabsList className="h-auto space-x-6 bg-transparent p-0">
                                <TabsTrigger
                                    value="timeline"
                                    data-tour="timeline-tab"
                                    className="rounded-none border-b-2 border-transparent bg-transparent px-0 py-2 text-sm font-medium data-[state=active]:border-gray-900 data-[state=active]:text-gray-900 data-[state=active]:shadow-none data-[state=inactive]:text-gray-500 dark:data-[state=active]:border-gray-100 dark:data-[state=active]:text-gray-100 dark:data-[state=inactive]:text-gray-400"
                                >
                                    Timeline
                                </TabsTrigger>
                                <TabsTrigger
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-48">
                                    <DropdownMenuItem
                                        ...
                                        className={cn("cursor-pointer", timelineFilter === "all" && "bg-gray-100 dark:bg-gray-800")}
                                    >
                                        All
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() => setTimelineFilter("meeting")}
                                        className={cn("cursor-pointer", timelineFilter === "meeting" && "bg-gray-100 dark:bg-gray-800")}
                                    >
                                        Calendar Events
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() => setTimelineFilter("email")}
                                        className={cn("cursor-pointer", timelineFilter === "email" && "bg-gray-100 dark:bg-gray-800")}
                                    >
                                        Emails
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() => setTimelineFilter("note")}
                                        className={cn("cursor-pointer", timelineFilter === "note" && "bg-gray-100 dark:bg-gray-800")}
                                    >
                                        Notes
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
                        ...
                        <ScrollArea className="h-full">
                            <div className="px-4 py-4 md:px-6">
                                ...
                                <div className="relative space-y-0">
                                    ...
                                    <div className="absolute top-0 bottom-0 left-3 z-0 w-[1px] -translate-x-1/2 bg-gray-200 dark:bg-gray-800" />

                                    {/* Note Input Entry */}
                                    <div className="relative z-10 py-4">
                                        {/* Header - only shown when editing or has text */}
                                        {(isNoteFocused || noteText.trim()) && (
                                            <div className="mb-2 ml-9 flex items-center gap-3">
                                                <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                                    <LabelIcon className="h-4 w-4" />
                                                    <span>Adding a note...</span>
                                                </div>
                                                <span className="mr-1 ml-auto text-xs text-gray-400 dark:text-gray-500">now</span>
                                            </div>
                                        )}

                                        <div className="flex items-start gap-3">
                                            {/* Timeline Icon */}
                                            <div className="z-10 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                                <NoteIcon className="h-3.5 w-3.5 text-gray-500 dark:text-gray-400" />
                                            </div>

                                            {/* Input Box */}
                                            <div className="flex-1 rounded-lg border border-gray-200 bg-gray-50/30 p-3 dark:border-gray-700 dark:bg-gray-800/30">
                                                <textarea
                                                    value={noteText}
                                                    ...
                                                    className="min-h-[80px] w-full resize-none bg-transparent text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none dark:text-gray-100 dark:placeholder:text-gray-500"
                                                />
                                                <div className="mt-2 flex items-center justify-end gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="rounded-md bg-gray-900 px-3 py-1.5 text-sm font-medium text-white hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-100 dark:hover:bg-gray-200"
                                                    >
                                    ...
                                    {displayTimeline.map((item, index) => {
                                        ...
                                        if (item.type === "email") {
                                            Icon = MailIcon;
                                            iconBgColor =
                                                item.iconColor === "purple" ? "bg-purple-100 dark:bg-purple-900/30" : "bg-blue-100 dark:bg-blue-900/30";
                                            iconTextColor =
                                                item.iconColor === "purple" ? "text-purple-600 dark:text-purple-400" : "text-blue-600 dark:text-blue-400";
                                        ...
                                        if (item.type === "note") {
                                            return (
                                                <div key={index} className="group relative z-10 py-4">
                                                    <div className="mb-2 flex items-center gap-3">
                                                        <div
                                                            className={`h-6 w-6 ${iconBgColor} flex flex-shrink-0 items-center justify-center rounded shadow-sm`}
                                                        >
                                                            <Icon className={`h-3.5 w-3.5 ${iconTextColor}`} />
                                                        </div>
                                                        <span className="text-sm font-medium text-gray-500 dark:text-gray-400">You added a note</span>
                                                        <span className="mr-1 ml-auto text-xs text-gray-400 group-hover:hidden dark:text-gray-500">
                                                            {item.date}
                                                        </span>
                                                        <button
                                                            onClick={() => handleDeleteNote(item.id, index)}
                                                            className="ml-auto hidden p-1 text-gray-400 transition-colors group-hover:flex hover:text-red-500 dark:text-gray-500 dark:hover:text-red-400"
                                                            title="Delete note"
                                                        >
                                                            <TrashIcon className="h-4 w-4" />
                                                        </button>
                                                    </div>
                                                    <div className="ml-9 rounded-xl border border-gray-100 bg-gray-50/80 p-4 dark:border-gray-800 dark:bg-gray-800/50">
                                                        <p className="text-sm whitespace-pre-wrap text-gray-700 dark:text-gray-300">{item.text}</p>
                                                    </div>
                                                </div>
                                            );
                                        }
                                        ...
                                        return (
                                            <div key={index} className="relative z-10 flex items-start gap-3 py-4">
                                                <div className={`h-6 w-6 ${iconBgColor} flex flex-shrink-0 items-center justify-center rounded shadow-sm`}>
                                                    <Icon className={`h-3.5 w-3.5 ${iconTextColor}`} />
                                                </div>
                                                    ...
                                                    <p className="text-sm text-gray-700 dark:text-gray-300">
                                                        {item.link ? (
                                                            <>
                                                                ...
                                                                <a
                                                                    href="#"
                                                                    className="text-gray-900 underline decoration-gray-400 underline-offset-2 hover:decoration-gray-600 dark:text-gray-100 dark:decoration-gray-500 dark:hover:decoration-gray-300"
                                                                >
                                                                    {item.link}
                                                                </a>
                                                            </>
                                                ...
                                                <span className="mt-0.5 flex-shrink-0 text-xs text-gray-400 dark:text-gray-500">{item.date}</span>
                                            </div>
                                        );
                                    })}
                                </div>
                    ...
                    <TabsContent value="about" className="m-0 flex-1 overflow-hidden">
                        <ScrollArea className="h-full">
                            <div className="space-y-6 px-4 py-4 md:px-6">
                                {/* Bio Section */}
                                {person.bio && (
                                    <div>
                                        <h3 className="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Bio</h3>
                                        <p className="text-sm whitespace-pre-wrap text-gray-600 dark:text-gray-400">{person.bio}</p>
                                    </div>
                                )}
                                ...
                                {(person.linkedin_url || person.twitter_url || person.instagram_url || person.facebook_url) && (
                                    <div>
                                        <h3 className="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">Social Media</h3>
                                        <div className="space-y-2">
                                            {person.linkedin_url && (
                                                <div className="flex items-center gap-2">
                                                    <span className="min-w-[80px] text-sm text-gray-600 dark:text-gray-400">LinkedIn</span>
                                                    <a
                                            ...
                                            {person.twitter_url && (
                                                <div className="flex items-center gap-2">
                                                    <span className="min-w-[80px] text-sm text-gray-600 dark:text-gray-400">Twitter/X</span>
                                                    <a
                                            ...
                                            {person.instagram_url && (
                                                <div className="flex items-center gap-2">
                                                    <span className="min-w-[80px] text-sm text-gray-600 dark:text-gray-400">Instagram</span>
                                                    <a
                                            ...
                                            {person.facebook_url && (
                                                <div className="flex items-center gap-2">
                                                    <span className="min-w-[80px] text-sm text-gray-600 dark:text-gray-400">Facebook</span>
                                                    <a
            ...
            {/* Resizable Divider */}
            <div ref={resizeRef} onMouseDown={handleMouseDown} className="group hidden w-1 flex-shrink-0 cursor-col-resize items-center justify-center lg:flex">
                <div className="h-full w-px bg-gray-200 transition-colors group-hover:bg-gray-300 dark:bg-gray-800 dark:group-hover:bg-gray-700" />
            </div>

            {/* Right Sidebar */}
            <div className="hidden h-full lg:block">
                <PersonDetailSidebar person={person} onToggleStar={handleToggleStar} firstName={firstName} panelWidth={panelWidth} />
            </div>

            {/* Delete Note Confirmation Modal */}
            <ModalOverlay isOpen={noteToDelete !== null} onOpenChange={(isOpen) => !isOpen && setNoteToDelete(null)}>
                <Modal className="max-w-md rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900">
                    <Dialog className="p-6">
                        <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-100">Delete Note</h2>
                        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
                            Are you sure you want to delete this note? This action cannot be undone.
                        </p>
                        <div className="flex justify-end gap-3">
                            <Button variant="outline" onClick={() => setNoteToDelete(null)} disabled={isDeletingNote}>
                                Cancel
                            </Button>
            ...
            <ModalOverlay isOpen={showDeletePersonModal} onOpenChange={(isOpen) => !isOpen && setShowDeletePersonModal(false)}>
                <Modal className="max-w-md rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900">
                    <Dialog className="p-6">
                        <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-100">Delete Person</h2>
                        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
                            Are you sure you want to delete {person?.name}? This action cannot be undone.
                        </p>
                        <div className="flex justify-end gap-3">
                            <Button variant="outline" onClick={() => setShowDeletePersonModal(false)} disabled={isDeletingPerson}>
                                Cancel
                            </Button>
                            <Button variant="destructive" onClick={handleDeletePerson} disabled={isDeletingPerson}>
