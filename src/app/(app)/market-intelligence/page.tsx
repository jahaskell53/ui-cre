            ...
            <div className="flex flex-col gap-8 p-6">
                <div className="mx-auto flex w-full max-w-7xl flex-col gap-10">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Deep insights into regional multi-family market trends.</p>
                    </div>

                    <div className="flex flex-col gap-6 rounded-2xl border border-gray-200 bg-gray-50 p-6 shadow-sm sm:flex-row dark:border-gray-800 dark:bg-gray-800/50">
                        <div className="w-full space-y-2 sm:w-48">
                            <Label className="text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">State</Label>
                            <Select
                                value={selectedState}
                                onValueChange={(value) => {
                            ...
                            >
                                <SelectTrigger className="h-10 border-gray-200 bg-white font-medium dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <div className="w-full space-y-2 sm:w-48">
                            <Label className="text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">County</Label>
                            <Select
                        ...
                        <div className="w-full space-y-2 sm:w-48">
                            <Label className="text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">City</Label>
                            <Select value={selectedCity} onValueChange={setSelectedCity} disabled={!selectedCounty}>
                                <SelectTrigger className="h-10 border-gray-200 bg-white font-medium dark:border-gray-700 dark:bg-gray-900">
                    ...
                    {marketData.location && (
                        <div className="flex items-center gap-3">
                            ...
                            <p className="px-4 text-xs font-bold tracking-[0.2em] text-gray-400 uppercase dark:text-gray-500">{marketData.location}</p>
                            <div className="h-px flex-1 bg-gray-100 dark:bg-gray-800" />
                        </div>
                    )}
                        ...
                        {marketData.tiles.map((tile, i) => (
                            ...
                            >
                                <div className="mb-6 flex items-start justify-between">
                                    <p className="text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">{tile.label}</p>
                                </div>
                                <div className="mb-2 flex items-center gap-2">
                                    {tile.trend && (
                                        <div className={tile.isPositive ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}>
                                            {tile.trend === "up" ? <ArrowUp className="size-5" /> : <ArrowDown className="size-5" />}
                                        </div>
                                    )}
                                    <h3
                                        className={`text-3xl font-bold tracking-tight ${tile.trend && tile.isPositive ? "text-green-600 dark:text-green-400" : tile.trend && !tile.isPositive ? "text-red-600 dark:text-red-400" : "text-gray-900 dark:text-gray-100"}`}
                                    >
                                        {tile.value}
                                    </h3>
                                </div>
                                {tile.subtitle && (
                                    <p className="mt-2 flex items-center gap-1.5 text-[11px] font-medium text-gray-500 dark:text-gray-400">
                                        <span className="size-1 rounded-full bg-gray-200 dark:bg-gray-700" />
                                        {tile.subtitle}
                                    </p>
                                )}
                            </div>
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex items-end justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-xs font-medium tracking-wider text-gray-500 uppercase dark:text-gray-400">
                                        {getCountyLabel()} County, {selectedState} • Last 18 Months
                                    </p>
                                </div>
                            </div>
                            <div
                                ...
                                style={{ height: "500px" }}
                            >
                                <PropertyMap properties={recentSales} className="h-full w-full" />
                            </div>
                        </div>
                    )}
                        ...
                        <div className="flex flex-col gap-10">
                            ...
                            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                <div className="mb-10">
                                    ...
                                    <p className="mt-1 text-xs font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                        {getCountyLabel().toUpperCase()} County • Price/Sq Ft
                                    </p>
                                </div>
                                <div className="w-full">
                                    <svg viewBox="0 0 600 300" className="h-auto w-full">
                                        {/* Y-axis labels */}
                                        {[0, 35, 70, 105, 140].map((val, i) => (
                                            <g key={i}>
                                                ...
                                                <text
                                                    ...
                                                    y={250 - (val / 140) * 200 + 4}
                                                    textAnchor="end"
                                                    className="fill-gray-400 text-[10px] font-bold dark:fill-gray-500"
                                                >
                                                    {val}
                                                </text>
                                            </g>
                                        ...
                                        {[
                                            ...
                                            <g key={i}>
                                                <rect
                                                    x={bar.x}
                                                    y={250 - (bar.val / 140) * 200}
                                                    width="100"
                                                    height={(bar.val / 140) * 200}
                                                    fill="currentColor"
                                                ...
                                                <text
                                                    x={bar.x + 50}
                                                    y={250 - (bar.val / 140) * 200 - 12}
                                                    textAnchor="middle"
                                                    className="fill-gray-900 text-xs font-bold dark:fill-gray-100"
                                                >
                                                    ${bar.val}
                                                </text>
                                                <text
                                                    ...
                                                    y="280"
                                                    textAnchor="middle"
                                                    className="fill-gray-500 text-[10px] font-bold tracking-widest uppercase dark:fill-gray-400"
                                                >
                                                    {bar.name}
                                                </text>
                                            </g>
                            ...
                            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                <div className="mb-10">
                                    ...
                                    <p className="mt-1 text-xs font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                        {getCountyLabel()} County vs CA State Average (30 Years)
                                    </p>
                                </div>
                                <div className="w-full">
                                    <svg viewBox="0 0 800 400" className="h-auto w-full">
                                            ...
                                            return (
                                                <g key={i}>
                                                    <line
                                                        ...
                                                        strokeDasharray="4,4"
                                                    />
                                                    <text x="70" y={y + 4} textAnchor="end" className="fill-gray-400 text-[10px] font-bold dark:fill-gray-500">
                                                        $
                                        ...
                                        <g transform="translate(560, 40)">
                                            ...
                                            <line
                                                ...
                                                strokeWidth="3"
                                            />
                                            <text x="55" y="24" className="fill-gray-900 text-[10px] font-bold tracking-widest uppercase dark:fill-gray-100">
                                                Colusa County
                                            </text>
                                            <line
                                                x1="20"
                                                ...
                                                strokeDasharray="4,4"
                                            />
                                            <text x="55" y="44" className="fill-gray-400 text-[10px] font-bold tracking-widest uppercase dark:fill-gray-500">
                                                CA State Avg
                                            </text>
                                        </g>
                                    </svg>
                            ...
                            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                <div className="border-b border-gray-100 p-8 dark:border-gray-800">
                                    ...
                                    <p className="mt-1 text-xs font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                        {getCountyLabel()} County • Last 18 Months
                                    </p>
                                </div>
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left text-sm">
                                        <thead className="border-b border-gray-100 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-800/50">
                                            <tr>
                                                <th className="px-8 py-4 text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                                    ZIP Code
                                                </th>
                                                <th className="px-8 py-4 text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                                    City
                                                </th>
                                                <th className="px-8 py-4 text-right text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                                    Median Price
                                                </th>
                                                <th className="px-8 py-4 text-right text-[10px] font-bold tracking-widest text-gray-400 uppercase dark:text-gray-500">
                                                    Avg Price
                                        ...
                                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                            {[
                                                ...
                                                <tr key={i} className="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                                    ...
                                                    <td className="px-8 py-5 font-medium text-gray-500 dark:text-gray-400">{row.city}</td>
                                                    <td className="px-8 py-5 text-right font-bold text-gray-900 dark:text-gray-100">{row.median}</td>
                                                    <td className="px-8 py-5 text-right font-medium text-gray-500 dark:text-gray-400">{row.avg}</td>
                                                    <td className="px-8 py-5 text-right font-medium text-gray-500 dark:text-gray-400">{row.count}</td>
                                                    <td className="px-8 py-5 text-right font-bold text-gray-900 dark:text-gray-100">{row.priceSqFt}</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
